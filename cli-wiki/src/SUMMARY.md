...
- [Text Manipulation](text-manipulation/README.md)
  - [grep](text-manipulation/grep.md)
  - [awk](text-manipulation/awk.md)
  - [sed](text-manipulation/sed.md)
  - [xargs](text-manipulation/xargs.md)
  - [find](text-manipulation/find.md)
  - [Examples](text-manipulation/example.md)
